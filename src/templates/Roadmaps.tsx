...
const Roadmaps = () => (
  <Section 
    title="Roadmaps"
    description="Below is our roadmaps"
  >
    <div>
      <div className="flex">
        <div className="w-1/3 text-center px-6">
          ...
          >
            <div
              className="w-1/3 bg-transparent h-20 flex items-center justify-center icon-step"
            >
            ...
            <div
              className="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step"
            >
              <h2 className="font-bold text-sm">Initiate the project</h2>
        ...
        <div className="w-1/3 text-center px-6">
          ...
          >
            ...
            <div
              className="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step"
            >
              <h2 className="font-bold text-sm">Launch site</h2>
              <p className="text-xs text-gray-600">
                Publicize the site
              </p>
            </div>
        ...
        <div className="w-1/3 text-center px-6">
          ...
          >
            ...
            <div
              className="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step"
            >
              <h2 className="font-bold text-sm">Finalize</h2>
              <p className="text-xs text-gray-600">
